...
def create_app(config_name="development"):
    ...
    try:
        ...
        print(
            f"⚠️ Could not create session directory: "
            f"{e}"
        )
    ...
    print(
        f"  Domain: "
        f"{app.config['SESSION_COOKIE_DOMAIN']}"
    )
    ...
    print(
        "✅ All application routes registered"
    )
